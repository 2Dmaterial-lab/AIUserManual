...
| **新入组同学** | 需要快速建立科研习惯 | [入组第一周训练](14-new-student-bootcamp.md) → [科研任务工作流](12-research-workflows.md) → [数据管理与可复现科研](13-data-reproducibility.md) |
...
| MATLAB 授权方式 | 待补充 |
| COMSOL 授权方式 | 待补充 |
| Origin/OriginPro 授权方式 | 待补充 |
| GitHub/GitLab 组织 | 待补充 |
| 组内共享存储/NAS | 待补充 |
| AI 工具付费或公用账号政策 | 待补充 |
...
建议组内统一最小目录结构，详见 [数据管理与可复现科研](13-data-reproducibility.md)：
...
├── scripts/         # 处理脚本
├── figures/         # 输出图表
└── notes/           # 实验记录、AI 使用记录、参数说明
```

每张用于论文或组会结论的图，建议至少保留：原始数据位置、处理脚本、图表源数据、导出图片和一段简短说明。
...
| 文件或政策 | 链接 | 适用场景 |
|------------|------|----------|
| 学校生成式 AI 使用规范 | 待补充 | 课程、论文、科研 |
| 学院论文写作或学术诚信要求 | 待补充 | 开题、投稿、答辩 |
| 目标期刊 AI 使用声明要求 | 待补充 | 投稿前检查 |
