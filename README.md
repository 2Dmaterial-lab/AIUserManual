...
**最近维护：2026-09-11**。主要 AI 产品与科研软件入口已核对；构建、站内链接与页脚行为检查见 [CONTRIBUTING.md](CONTRIBUTING.md)。
...
| 章节 | 内容 | 链接 |
|------|------|------|
| 12 | 科研任务工作流：文献、数据、仿真、仪器、投稿检查 | [research-workflows.md](docs/12-research-workflows.md) |
| 13 | 数据管理与可复现科研 | [data-reproducibility.md](docs/13-data-reproducibility.md) |
| 14 | 入组第一周训练 | [new-student-bootcamp.md](docs/14-new-student-bootcamp.md) |
...
- **刚入组的同学**：按第 14 章完成 5 天训练，先建立数据、文献和 AI 使用边界
- **有基础的同学**：直接跳到你使用的工具章节，重点看"AI辅助使用核心技巧"和"提示词示例"部分
- **正在推进课题的同学**：优先看第 12、13 章，把文献、数据、仿真和论文图组织成可复现流程
...
维护说明：统计服务不可用时，部署会在 Actions 摘要中提示并隐藏页脚计数，手册正文仍可发布。
